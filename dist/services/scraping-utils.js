...
const WrongScrapersConfigError_1 = __importDefault(
  require("../errors/WrongScrapersConfigError")
);
  ...
  function verifyConfig(config) {
    ...
    for (let SourceName of Object.keys(config.scrapers)) {
      ...
      if (trustLevels.includes(targetScraper.trustLevel)) {
        throw new WrongScrapersConfigError_1.default(
...
})(ScrapingUtils || (exports.ScrapingUtils = ScrapingUtils = {}));
