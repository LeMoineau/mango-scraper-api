...
const formatted_name_service_1 = __importDefault(
  require("../services/formatted-name.service")
);
  ...
  get({ srcs }) {
    return __awaiter(this, void 0, void 0, function* () {
      ...
      for (let src of srcs ? srcs : config_1.default.getEnabledSource()) {
        const chapters = yield config_1.default
          .getScraperOfSrc(src)
          .getLatestChapters();
        chaptersBySrc[src] = chapters;
      }
      const intersiteChapters =
        intersite_utils_1.IntersiteUtils.convertChaptersToIntersiteChapters(
          chaptersBySrc
        );
