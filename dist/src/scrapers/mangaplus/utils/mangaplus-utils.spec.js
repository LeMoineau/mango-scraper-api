...
const mangaplus_utils_1 = require("./mangaplus-utils");
const mangaplus_scraper_1 = __importDefault(require("../mangaplus-scraper"));
(0, vitest_1.describe)("mangaplus-utils", () => {
    const A_Uint8Array = {};
    const A_TYPE = {};
    ...
    (0, vitest_1.it)("should call ProtoManaging httpGetProtoFile with correct endpoint when get all chapters", () => __awaiter(void 0, void 0, void 0, function* () {
        yield mangaplus_utils_1.MangaplusUtils.decodeJsonFromMangaPlusRequest(`${mangaplus_scraper_1.default["API_ENDPOINT"]}/web/web_homeV3?lang=eng`, `${__dirname}/protos/web_homeV3.proto`, "mangaplus.Web_homeV3");
        (0, vitest_1.expect)(proto_managing_1.ProtoManaging.httpGetProtoFile).toHaveBeenCalledWith(`${mangaplus_scraper_1.default["API_ENDPOINT"]}/web/web_homeV3?lang=eng`);
    }));
