...
(function (RoutingUtils) {
    ...
    RoutingUtils.isValidSrc = isValidSrc;
    function areValidSrcs(querySrcs) {
        return array_utils_1.ArrayUtils.includesAll(config_1.default.getEnabledSource(), querySrcs);
    }
    RoutingUtils.areValidSrcs = areValidSrcs;
