...
latestChaptersRouter.get("/", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      const syncWithBD =
        routing_utils_1.RoutingUtils.convertQueryParamToBoolean(
          req.query.syncWithBD
        );
      const async = routing_utils_1.RoutingUtils.convertQueryParamToBoolean(
        req.query.async
      );
      try {
        ...
        res.send(
          yield latest_chapters_controller_1.default.getAll({
            srcs: srcs && srcs,
            syncWithBD,
            async,
          })
