...
const correct_response_example_1 = require("./test-examples/correct-response-example");
const mangaplus_scraper_1 = __importDefault(require("./mangaplus-scraper"));
(0, vitest_1.describe)("mangaplus-scraper", () => {
    const A_Uint8Array = {};
    const A_TYPE = {};
    const A_CORRECT_JSON = correct_response_example_1.exampleWeb_homeV3Json;
    ...
    (0, vitest_1.it)("should return correct chapters json when getting all chapters", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        (0, vitest_1.expect)(chapters).toStrictEqual(correct_response_example_1.exampleFinalMangaPlusChaptersJson);
    }));
});
