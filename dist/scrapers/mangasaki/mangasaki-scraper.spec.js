...
const actual_mangasaki_page_1 = require("./test-examples/actual-mangasaki-page");
(0, vitest_1.describe)("mangasaki-scraper", () => {
    const A_$ = (0, cheerio_1.load)(actual_mangasaki_page_1.MANGASAKI_HOME_PAGE_HTML);
    const THE_MANGASAKI_HOME_PAGE = (0, cheerio_1.load)(actual_mangasaki_page_1.MANGASAKI_HOME_PAGE_HTML);
